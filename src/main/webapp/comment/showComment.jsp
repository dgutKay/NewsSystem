...
<body>
	<form
		action="/NewsSystem/servlet/NewsServlet?condition=showANews&newsId=${param.newsId}"
		...
		<div class="center" style="width:600px">
			...
			<div class="commentsHead" style="text-align:center;">
				<c:if test="${requestScope.pageInformation.page > 1}">
					<td><a href="javascript:void(0);" onclick="getOnePage('pre');">Previous</a></td>
				</c:if>
				<c:if
					test="${requestScope.pageInformation.page < requestScope.pageInformation.totalPageCount}">
					<td><a href="javascript:void(0);"
						onclick="getOnePage('next');">Next</a></td>
				</c:if>
			</div>
		</div>
